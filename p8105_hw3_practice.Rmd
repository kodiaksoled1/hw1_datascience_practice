...
accel_data %>%
  ...
  labs(
    ...
    caption = "Data from the Accelerometer Dataset")
```
* These plots allow us to see that this man's activity increased across the week (from monday to sunday) for weeks 1, 2, and 3. However, for weeks 4 and 5, there is a sharp decline in activity that occurs over the weekend compared to the weekday.
