...
* The Mr. Trash Wheel dataset contains `r nrow(mr_trash_wheel)` observations and `r ncol(mr_trash_wheel)` variables for a total of `r nrow(mr_trash_wheel)*ncol(mr_trash_wheel)` cells. 
* The `r length(mr_trash_wheel)` variables include: dumpster, month, year, date, weight (tons), volume (cubic yards), etc. from May 2014 until June 2019. 
