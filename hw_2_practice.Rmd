...
### The Mr. Trash Wheel dataset contains `r length(mr_trash_wheel)` variables including: dumpster, month, year, date, weight (tons), etc. from May 2014 until June 2019. It is contains `r nrow(mr_trash_wheel)` rows/observations and `r ncol(mr_trash_wheel)` columns/variables for a total of `r nrow(mr_trash_wheel)*ncol(mr_trash_wheel)` cells. The median number of sports balls in a dumpster in 2017 was `r median(pull(mr_trash_wheel %>% filter(year == "2017"), sports_balls))`.
