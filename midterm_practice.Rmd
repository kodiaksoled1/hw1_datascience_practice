...
### These show fhp_size doesn't increase until age 55 and is only slightly larger in males.
...
### "eop_size" and "eop_visibility_classification" were not categorized this way. A new variable "eeop" was created during data cleaning to meet this definition. 
